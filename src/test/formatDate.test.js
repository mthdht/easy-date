...
const tests = [
  { format: 'dateShort', expected: '23/04/2025', label: 'dateShort' },
  { format: 'dateCompact', expected: '23/04', label: 'dateCompact' },
  { format: 'dateText', expected: 'mercredi 23 avril 2025', label: 'dateText' },
  { format: 'dateShortText', expected: 'mer. 23 avr. 2025', label: 'dateShortText' },
  { format: 'dateTextMonth', expected: '23 avril 2025', label: 'dateTextMonth' },
  { format: 'dateIso', expected: '2025-04-23', label: 'dateIso' },
  { format: 'dateIsoFull', expected: '2025-04-23 15:45:30', label: 'dateIsoFull' },
  { format: 'time24h', expected: '15:45', label: 'time24h' },
  { format: 'time24hSeconds', expected: '15:45:30', label: 'time24hSeconds' },
  { format: 'time12h', expected: '03:45 PM', label: 'time12h' },
  { format: 'dateTime', expected: '23/04/2025 à 15:45', label: 'dateTime' },
  { format: 'dateTimeText', expected: 'mercredi 23 avril 2025 à 15:45', label: 'dateTimeText' },
  { format: 'isoTimestamp', expected: '2025-04-23 15:45:30', label: 'isoTimestamp' },
